"""
DEPRECATED — createRenderInfo.py
...
and is generated by LUSID/src/xml_etree_parser.py.
...
def createRenderInfoJSON(processed_dir="processedData", output_path=None):
    ...
    warnings.warn(
        ...
        "The pipeline now uses LUSID/src/xml_etree_parser.py to generate scene.lusid.json. "
        "See LUSID/internalDocs/DEVELOPMENT.md.",
        DeprecationWarning,
        stacklevel=2,
    )
    from LUSID.src.old_XML_parse.xmlParser import load_processed_data_and_build_scene
